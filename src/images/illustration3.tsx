        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g transform="matrix(-1 0 0 1 440 83)">
            ...
            <path
              ...
              mask="url(#d)"
            ></path>
            <path fill="#306299" d="M254.549 90.872L237.564 88 235 103.799 256 110z"></path>
            <path fill="#FA9E89" d="M237 89.118S223.824 88.77 210 83l6.496 12.254L235.249 101 237 89.118z"></path>
            ...
            ></path>
            <path fill="#306299" d="M266 107l-21.017 40-.546-17.991-.437-14.598L261.524 107z"></path>
            <path
              fill="#FFF"
            ...
            <path
              ...
              opacity="0.184"
            ></path>
            <path fill="#4EC9B4" d="M170 139.442L176.982 109 188 110.816 177.316 155z"></path>
            <path
              fill="#FA9E89"
            ...
            ></path>
            <path fill="#224A7D" d="M66 199c0 3.866-12.984 7-29 7s-29-3.134-29-7 12.984-7 29-7 29 3.134 29 7"></path>
            <path fill="#6397D9" d="M66 198c0 3.866-12.984 7-29 7s-29-3.134-29-7 12.984-7 29-7 29 3.134 29 7"></path>
            <path
              fill="#162F44"
            ...
            ></path>
            <path fill="#8CC5F2" d="M65.994 197v4.085s.39 2.043-4.994 3.915l1.652-4.766s2.86-1.277 3.342-3.234"></path>
            <path
              fill="#FC516B"
            ...
            ></path>
            <path fill="#9B293F" d="M47 183c0 .552-4.03 1-9 1s-9-.448-9-1 4.03-1 9-1 9 .448 9 1"></path>
            <path
              fill="#F995A9"
