...
interface IChromeIconProps extends JSX.IntrinsicAttributes {
  width?: string
  height?: string
  className?: string
}
const ChromeIcon = ({ className, width, height }: IChromeIconProps) => {
  const classes = useIconStyles()
  return (
    <div className={classnames(className, classes.iconWrapper)}>
      <svg xmlns="http://www.w3.org/2000/svg" width={width ? width : '102'} height={height ? height : '100'}>
        <g fill="none">
          <path
            fill="#E16B5A"
