...
const ExtensionCard = ({ browserIcon, browserName, browserVersion, navigateTo }: IExtensionProps) => {
  return (
    <div className="extensionCard">
      ...
      <PrimaryButton text="Add & install Extension" variant="primary" navigateTo={navigateTo} />
    </div>
  )
}
